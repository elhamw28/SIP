        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                <div class="card p-3 shadow rounded h-100 p-4">
                    <h6 class="mb-4 text-black">Data Barang Masuk</h6>
                    <div class="box-body">
                    <a href="tambah/tambah_barang_masuk.php" class="btn btn-success">Tambah
                        Data</a>
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                            $sql = "SELECT barang_masuk.kode_in, produk.nama_produk, barang_masuk.tgl_masuk, barang_masuk.jumlah, 
                            barang_masuk.keterangan FROM barang_masuk JOIN produk ON barang_masuk.kode_produk=produk.kode_produk";
                            $query = mysqli_query($koneksi, $sql);

                            while ($produk = mysqli_fetch_array($query)) {
                                echo "<tr>";
                                echo "<td>" . $produk['kode_in'] . "</td>";
                                echo "<td>" . $produk['nama_produk'] . "</td>";
                                echo "<td>" . $produk['tgl_masuk'] . "</td>";
                            ...
                            <a class="btn btn-success" data-target="#editMenu" class="badge badge-success"
                                href="Edit/edit_barang_masuk.php?id='<?php echo $produk['kode_in'] ?>'">Edit</a>
                            <!-- Hapus -->
                            <a class="btn btn-danger" onclick="return confirm('Anda yakin akan menghapus ini? ')"
                                href="Proses_delete/hapus_barang_masuk.php?kode_in='<?php echo $produk['kode_in'] ?>'">Delete</a>
                            </td>
                            </tr>
                            <?php
                                echo "</td>";
