            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="../proses_simpan/simpan_transaksi.php" method="POST">
                                ...
                                <div class="form-group">
                                    <label>Jumlah</label>
                                    <input type="text" class="form-control form-control-user" id="jumlah" name="jumlah" placeholder="Masukkan Jumlah" onFocus="startCalc();" onBlur="stopCalc();">
                                </div>
                                <div class="form-group">
                                    <label>Total</label>
                                    <input type="text" class="form-control form-control-user" id="total" name="total" placeholder="Total" onchange='tryNumberFormat(this.form.thirdBox);'>
                                </div>
