            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="../proses_simpan/simpan_barang_keluar.php" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="tanggal_keluar" placeholder="Masukan Tanggal Keluar">
                                </div>
                                <div class="form-group">
                                    <label>Jumlah</label>
