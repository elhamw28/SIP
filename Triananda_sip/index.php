...
<body>
        ...
        <div class="row g-12">
            <div class="col-sm-12 col-xl-12">
                <div class="card p-2 shadow text-left rounded p-4">
                    ...
                    <p text-align="left">
                        adalah acara perusahaan yang bergerak di bidang penjualan makanan ringan di Indonesia.

                        Produk unggulan kami adalah makanan ringan keripik kentang, kacangan khas indonesia, wafer,
                        biskuit dan olahan rumput laut.

                        Dengan 3 unit pengolahan, pabrik pengolahan makanan ringan kami telah memenuhi standar nasional
                        dan internasional yang diakui oleh pemerintah Indonesia.

                        Melalui inovasi dan manajemen berkelanjutan, kami terus berupaya memberikan pelayanan yang
    ...
    <div class="container-fluid pt-4 px-4">
        <div class="row g-12">
            <div class="col-sm-4 ">
                <div class="card p-2 shadow text-left rounded h-100  p-2">
                    <img src="img/gedung.jpeg" width="100%" height="100%" alt="Sawah" />
                </div>
            </div>
            <div class="col-sm-4">
                <div class="card p-2 shadow bg-white rounded h-100 p-2">
                    <img src="img/pabrik.jpeg" width="100%" height="100%" alt="Sawah" />
                </div>
            </div>

            <div class="col-sm-4">
                <div class="card p-2 shadow bg-white rounded h-100 p-2">
                    <img src="img/keripik.jpeg" width="100%" height="100%" alt="Sawah" />
                </div>
            </div>
        </div>
    </div>
