...
$id = $_GET['id'];
$query = "SELECT * FROM review WHERE kode_review =$id LIMIT 1";
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="../proses_edit/edit_review.php" method="POST">
                                <div class="from-group">
                                    <label class="col-sm-12 col-md-2 col-form-label">Kode
                                        Review</label>
                                    <input type="text" name="kode_review" placeholder="Masukan Kode Review" class="form-control" value="<?php echo $row['kode_review'] ?>">
                                </div>
                                ...
                                <a href="../review.php" class="btn btn-danger">BATAL</a>
                            </form>
                        </div>
                    </div>
                </div>
