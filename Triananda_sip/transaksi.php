        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                <div class="card p-3 shadow rounded h-100 p-4">
                    <h6 class="mb-4 text-black">Data Transaksi</h6>
                    <div class="box-body">
                    <a href="tambah/tambah_transaksi.php" class="btn btn-success">Tambah
                        Transaksi</a>
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                            $sql = "SELECT transaksi.kode_transaksi, customer.nama, transaksi.tgl_transaksi, 
                            produk.nama_produk, transaksi.harga, transaksi.jumlah, transaksi.total FROM transaksi 
                            JOIN customer ON transaksi.kode_customer = customer.kode_customer JOIN produk 
                            ON transaksi.kode_produk=produk.kode_produk";
                            $query = mysqli_query($koneksi, $sql);

                            while ($produk = mysqli_fetch_array($query)) {
                                echo "<tr>";
                                echo "<td>" . $produk['kode_transaksi'] . "</td>";
                                echo "<td>" . $produk['nama'] . "</td>";
                                echo "<td>" . $produk['tgl_transaksi'] . "</td>";
                            ...
                            <a class="btn btn-success" data-target="#editMenu" class="badge badge-success"
                                href="Edit/edit_transaksi.php?id='<?php echo $produk['kode_transaksi'] ?>'">Edit</a>


                            <a class="btn btn-danger" onclick="return confirm('Anda yakin akan menghapus ini? ')"
                                href="Proses_delete/hapus_transaksi.php?kode_transaksi='<?php echo $produk['kode_transaksi'] ?>'">Delete</a>
                            </td>
                            </tr>
                            <?php
                                echo "</td>";
