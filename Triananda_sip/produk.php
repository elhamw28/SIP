        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                <div class="card p-3 shadow rounded h-100 p-4">
                    <h6 class="mb-4 text-black">Data Produk</h6>
                    <div class="box-body">
                    <a href="tambah/tambah_produk.php" class="btn btn-success">Tambah
                        Poduk</a>
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            while ($produk = mysqli_fetch_array($query)) {
                                ...
                                echo "<td>" . $produk['tgl_pembuatan'] . "</td>";
                                echo "<td>" . $produk['tgl_kadaluarsa'] . "</td>";
                            ...
                            <a class="btn btn-success" data-target="#editMenu" class="badge badge-success"
                                href="Edit/edit_produk.php?id='<?php echo $produk['kode_produk'] ?>'">Edit</a>

                            <!-- Hapus -->
                            <a class="btn btn-danger" onclick="return confirm('Anda yakin akan menghapus ini? ')"
                                href="Proses_delete/hapus_produk.php?kode_produk='<?php echo $produk['kode_produk'] ?>'">Delete</a>
