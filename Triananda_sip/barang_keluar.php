        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                <div class="card p-3 shadow rounded h-100 p-4">
                    <h6 class="mb-4 text-black">Data Barang Keluar</h6>
                    <div class="box-body">
                    <a href="tambah/tambah_barang_keluar.php" class="btn btn-success">Tambah
                        Data</a>
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                            $sql = "SELECT barang_keluar.kode_out, produk.nama_produk, barang_keluar.tgl_keluar, barang_keluar.jumlah, 
                            barang_keluar.keterangan  FROM barang_keluar JOIN produk ON barang_keluar.kode_produk=produk.kode_produk";
                            $query = mysqli_query($koneksi, $sql);

                            while ($produk = mysqli_fetch_array($query)) {
                                echo "<tr>";
                                echo "<td>" . $produk['kode_out'] . "</td>";
                                echo "<td>" . $produk['nama_produk'] . "</td>";
                                echo "<td>" . $produk['tgl_keluar'] . "</td>";
                            ...
                            <a class="btn btn-success" data-target="#editMenu" class="badge badge-success"
                                href="Edit/edit_barang_keluar.php?id='<?php echo $produk['kode_out'] ?>'">Edit</a>
                            <!-- Hapus -->
                            <a class="btn btn-danger" onclick="return confirm('Anda yakin akan menghapus ini? ')"
                                href="Proses_delete/hapus_barang_keluar.php?kode_out='<?php echo $produk['kode_out'] ?>'">Delete</a>
                            </td>
                            </tr>
                            <?php
                                echo "</td>";
