...
$id = $_GET['id'];
$query = "SELECT * FROM customer WHERE kode_customer =$id LIMIT 1";
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="../proses_edit/edit_customer.php" method="POST">
                                <div class="from-group">
                                    <label class="col-sm-12 col-md-2 col-form-label">Id
                                        Customer</label>
                                    <input type="text" name="kode_customer" placeholder="Masukan Customer" class="form-control" value="<?php echo $row['kode_customer'] ?>">
                                </div>
