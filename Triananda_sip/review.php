        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                <div class="card p-3 shadow rounded h-100 p-4">
                    <h6 class="mb-4 text-black">Data Review</h6>
                    <div class="box-body">
                    <a href="tambah/tambah_review.php" class="btn btn-success">Tambah
                        Review</a>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <?php
                            $sql = "SELECT review.kode_review, customer.nama, produk.nama_produk, review.review, review.nilai 
                            FROM review JOIN customer ON review.kode_customer=customer.kode_customer 
                            JOIN produk ON review.kode_produk=produk.kode_produk";
                            $query = mysqli_query($koneksi, $sql);

                            while ($produk = mysqli_fetch_array($query)) {
                                echo "<tr>";
                                echo "<td>" . $produk['kode_review'] . "</td>";
                                echo "<td>" . $produk['nama'] . "</td>";
                                echo "<td>" . $produk['nama_produk'] . "</td>";
                                echo "<td>" . $produk['review'] . "</td>";
                                echo "<td>" . $produk['nilai'] . "</td>";
                                echo "<td>";
                            ?>

                            <!-- Edit -->
                            <a class="btn btn-success" data-target="#editMenu" class="badge badge-success"
                                href="Edit/edit_review.php?id='<?php echo $produk['kode_review'] ?>'">Edit</a>


                            <a class="btn btn-danger" onclick="return confirm('Anda yakin akan menghapus ini? ')"
                                href="Proses_delete/hapus_review.php?kode_review='<?php echo $produk['kode_review'] ?>'">Delete</a>
                            </td>
                            </tr>
                            <?php
                                echo "</td>";
