...
$id = $_GET['id'];
$query = "SELECT * FROM produk WHERE kode_produk =$id LIMIT 1";
                        ...
                        <div class="card-body">
                            <form action="../proses_simpan/simpan_produk.php" method="POST">
                                <div class="from-group">
                                    ...
                                    <input type="text" name="kode_produk" placeholder="Masukan Produk"
                                        class="form-control" value="<?php echo $row['kode_produk'] ?>">
                                </div>
